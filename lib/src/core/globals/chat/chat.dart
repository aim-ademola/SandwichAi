          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text(
                  room?.isPinned == true ? 'Unpin chat' : 'Pin chat',
                  style: TextStyle(color: context.modeTextPrimary),
                ),
                onTap: () {
                  Navigator.pop(ctx);
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: (_, _) =>
            Divider(height: 0, indent: 16, color: context.modeDivider),
        itemBuilder: (context, index) {
                    ...
                    decoration: BoxDecoration(
                      color: isMe
                          ? (message.id.startsWith('temp_')
                                ? context.modePrimary.withValues(alpha: 0.6)
                                : context.modePrimary)
                          : context.modeSurface,
                      borderRadius: BorderRadius.circular(12),
                      border: isMe
  ...
  Widget _buildReplyContent(ChatMessageModel parent, bool isMe) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isMe
            ? Colors.transparent
            : context.modeSurfaceAlt.withValues(alpha: 0.7),
          ...
          Row(
            children: [
              AppIcon(
                ...
                size: 14,
                color: isMe
                    ? context.modeTextInverse.withValues(alpha: 0.78)
    ...
    switch (message.messageType) {
      case 'IMAGE':
          ...
          if (path.startsWith('/')) {
            return ClipRRect(
              ...
              child: Image.file(
                ...
                width: 180,
                fit: BoxFit.cover,
                errorBuilder: (_, _, _) => _imagePlaceholder(isMe),
              ),
            );
          }
        ...
        return Text(
          message.content,
          style: TextStyle(
            color: isMe ? context.modeTextInverse : context.modeTextPrimary,
            fontSize: 14,
          ),
        );
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: isMe
                      ? context.modeTextInverse.withValues(alpha: 0.3)
                      : context.modeSurfaceAlt,
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 12,
                  color: isMe
                      ? context.modeTextInverse.withValues(alpha: 0.82)
                      : context.modeTextSecondary,
                ),
              ),
            ],
